    ...
    jQuery.mbYTPlayer = {
        ...
        buildPlayer: function(options) {
            ...
            return jQuery(function() {
                ...
                YTPlayer.loop = 0, YTPlayer.state = 0, YTPlayer.filters = jQuery.extend(!0, {}, jQuery.mbYTPlayer.defaultFilters), YTPlayer.filtersEnabled = !0, YTPlayer.id = YTPlayer.id || "YTP_" + (new Date).getTime(), $YTPlayer.addClass("mb_YTPlayer");
                ...
                "object" != typeof property ? (property = {}, jQuery.mbYTPlayer.defaults.containment = this, $YTPlayer.show()) : $YTPlayer.hide(), YTPlayer.opt = jQuery.extend(!0, {}, jQuery.mbYTPlayer.defaults, YTPlayer.opt, options, property), YTPRndSuffix = getYTPVideoID(YTPlayer.opt.videoURL).videoID, YTPTimerLabels = {
                    init: "YTPlayerInit_" + YTPRndSuffix,
                    startPlaying: "YTPlayerStartPlay_" + YTPRndSuffix
